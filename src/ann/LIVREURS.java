 ...
 * @author PC
 */
public class LIVREURS extends javax.swing.JFrame {

    /**
     * Creates new form LIVREURS
     */
    public LIVREURS() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INFORMATION DE LIVREUR");

        jLabel2.setText("NOM ET PRENOM");

        jLabel3.setText("DATE ET LIEU DE NISSANCE ");

        jLabel4.setText("N IDENTITE NATIONALE");

        jLabel5.setText("ADRESSE");

        jLabel6.setText("NUMERO DE TELEPHONE");

        jLabel7.setText("NUMERO DU PERMIS");

        jLabel8.setText("DATE DE EXPIRATION DE PERMIS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LIVREURS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
